...
<nav class="navbar navbar-default">
        ...
        <!--            SEARCH BAR-->
                ...
                if (isset($_POST['submit_soeg'])) {
                    ...
                    $soeg_esc = $db->real_escape_string($_POST['soeg']);

                    $_SESSION['search'] = [];

                    $_SESSION['search']['query'] = $soeg_esc;

                    redirect_to('index.php?page=soegning');
                }
                ?>
                <form method="post" action="" class="navbar-form navbar-right" role="search">
                    ...
                    <button <?php if ($side_url === 'soegning') { echo 'disabled'; } ?> type="submit" class="btn btn-default btn-sm" name="submit_soeg">
